...
my $dir = "/leofs/wulin_group/zhangcm/panqf/omics/02_rna_protein/06_correlation_bypathway";

open (STA, "> /leofs/wulin_group/zhangcm/panqf/omics/02_rna_protein/06_s3_correlation_bypathway_R.sh") or die;
