...
open (OUT1, "> /leofs/wulin_group/zhangcm/panqf/omics/02_rna_protein/11_abundance_matrix_mrna.txt") or die;
...
open (IN2, "/leofs/wulin_group/zhangcm/panqf/protein/02_MaxQuant/01_quant_extract/01_s1_quant_extract_unique_razor_LFQ.txt") or die;
open (OUT2, "> /leofs/wulin_group/zhangcm/panqf/omics/02_rna_protein/11_abundance_matrix_protein_UR.txt") or die;
