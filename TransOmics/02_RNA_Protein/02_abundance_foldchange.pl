...
open (IN1, "$dir/01_abundance_matrix_mrna.txt") or die;
open (OUT1, "> $dir/02_abundance_foldchange_mrna.txt") or die;
...
open (IN2, "$dir/01_abundance_matrix_protein.txt") or die;
open (OUT2, "> $dir/02_abundance_foldchange_protein.txt") or die;
