...
my $dir = "/leofs/wulin_group/zhangcm/panqf/omics/02_rna_protein/04_correlation_bysample";
my @sample = qw/Foldchange1 Foldchange2 Foldchange3 Foldchange4 Foldchange5 Foldchange_mean/;

open (STA, "> /leofs/wulin_group/zhangcm/panqf/omics/02_rna_protein/05_gene_regulation_statistics.txt") or die;
